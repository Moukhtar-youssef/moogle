...
POPULAR_DOMAINS = [
    ...
    "pro", "xyz", "online", "site", "shop", "store", "blog", "news", "media",
    "art", "film", "game", "games", "tech", "app", "dev", "ai", "cloud", "io",
    "co", "me", "tv", "ly", "to", "fm", "wiki", "help",

    # Country Code TLDs
    "us", "uk", "ca", "au", "de", "fr", "jp", "cn", "ru", "br", "in", "cl",
    "mx", "es", "it", "nl", "se", "no", "fi", "dk", "pl", "be", "ch", "at",
    "nz", "za", "sg", "hk", "kr", "id", "my", "ph", "th", "vn", "il", "sa",
    "ae", "tr", "eg", "ar", "co", "pe", "ve", "pk", "ng", "ke", "tz", "ro",
    ...
    "uber", "lyft", "doordash", "tesla", "openai", "nvidia", "amd", "intel",
    "samsung", "huawei", "xiaomi", "sony", "bbc", "cnn", "nytimes", "forbes",
